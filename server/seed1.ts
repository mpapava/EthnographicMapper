  ...
  try {
    ...
    await db.insert(blogPosts).values([
      ...
      },
      {
        ...
        titleKa: "მეფე თამარის ლეგენდა და ქართული ერთობა",
        titleRu: "Легенда о царице Тамар и грузинском единстве",
        ...
        excerptKa: "გამოიკვლიეთ მეფე თამარის ლეგენდარული მეფობა და როგორ ჩამოაყალიბა მისმა ლიდერობამ ქართული იდენტობა და კულტურული ტრადიციები.",
        excerptRu: "Исследуйте легендарное правление царицы Тамар и то, как ее лидерство сформировало грузинскую идентичность и культурные традиции.",
      ...
      },
      {
        ...
        titleKa: "პოლიფონიური სიმღერა: საქართველოს მუსიკალური სული",
        titleRu: "Полифоническое пение: музыкальная душа Грузии",
        ...
        excerptKa: "აღმოაჩინეთ ქართული პოლიფონიური სიმღერის უძველესი ტრადიცია და მისი ღრმა კულტურული მნიშვნელობა.",
        excerptRu: "Откройте древнюю традицию грузинского полифонического пения и его глубокое культурное значение.",
      ...
      {
        title: "The Ancient Art of Cloisonné: Georgian Metalwork",
        titleKa: "კლუაზონეს უძველესი ხელოვნება: ქართული ლითონის მუშაობა",
        titleRu: "Древнее искусство клуазоне: грузинская работа по металлу",
        slug: "ancient-art-cloisonne-georgian-metalwork",
        content: "Georgian cloisonné enamelwork represents one of the finest traditions of medieval decorative arts. From the intricate jewelry of ancient Colchis to the magnificent ecclesiastical objects of the Middle Ages, Georgian artisans have mastered the delicate technique of creating miniature worlds in precious metals...",
        excerpt: "Learn about Georgia's masterful tradition of cloisonné metalwork and its artistic heritage.",
        excerptKa: "გაიგეთ საქართველოს ოსტატური კლუაზონეს ლითონის მუშაობის ტრადიციისა და მისი მხატვრული მემკვიდრეობის შესახებ.",
        excerptRu: "Узнайте о мастерской традиции грузинской работы по металлу клуазоне и ее художественном наследии.",
      ...
      },
      {
        ...
        titleKa: "წმინდა მთები: სულიერება ქართულ მაღალმთიანეთში",
        titleRu: "Священные горы: духовность в грузинских высокогорьях",
        ...
        excerptKa: "გამოიკვლიეთ საქართველოს წმინდა მთების სულიერი მნიშვნელობა და მათი როლი კულტურული შენარჩუნებაში.",
        excerptRu: "Исследуйте духовное значение священных гор Грузии и их роль в сохранении культуры.",
        imageUrl: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      ...
      },
      {
        ...
        titleKa: "ცოცხალი ენა: ქართული წერა და ლიტერატურა",
        titleRu: "Живой язык: грузинская письменность и литература",
        ...
        excerptKa: "აღმოაჩინეთ უნიკალური ქართული წერა და მისი მნიშვნელოვანი როლი ლიტერატურისა და კულტურული იდენტობის შენარჩუნებაში.",
        excerptRu: "Откройте уникальную грузинскую письменность и ее важную роль в сохранении литературы и культурной идентичности.",
